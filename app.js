...
return([a+b+c,a*b*c,`${a} and ${b} and ${c} sum to ${a+b+c}.`,`The product of ${a} and ${b} and ${c} is ${b*c*a}.`])
}
...
function sumArray(sumArr) { //eslint-disable-line
    ...
    // arr = arr.slice(0, -1);
    // console.log(` a ${sumArr} was passed in as an array of numbers, and ${sum1} is their sum.`);
